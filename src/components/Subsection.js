...
import collageanimal from "../components/images/collageanimal.png"
const Subsection = () => {
  return (
    <div>
      <div className="container col-xxl-8 px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div className="col-10 col-sm-8 col-lg-6">
                <img src={collageanimal} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes"
                    style={{width:"700", height:"500", loading:"lazy"}}/>
            </div>
            <div className="col-lg-6">
                <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3 text-center">Stay Connected !!!</h1>
                <p className="lead">Join the community</p>
                <p className="lead">Follow us on Social Media.</p>
                <div className="d-flex justify-content-around">
                    ...
                    <a href="https://www.linkedin.com" className="logolinks" target="_blank"
                    ...
                    <a href="youtube.com" className="logolinks" target="_blank" style={{color: "#CD201F"}}>
                        <svg xmlns="http://www.w3.org/2000/svg" style={{width:"35",height:"35", fill:"currentColor"}}
